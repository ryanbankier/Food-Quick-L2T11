...
public class Main {
	...
	public static void main(String[] args) {
		...
		String[] cityToChoose = { "Cape Town", "Durban", "Johannesburg", "Potchefstroom", "Springbok", "Bloemfontein",
				"Port Elizabeth", "Witbank" };
		...
		// While loop runs until all order information for Customer Class and Restaurant
		// Class are captured
		while (runP == true) {
